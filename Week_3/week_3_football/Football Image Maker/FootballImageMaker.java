...
public class FootballImageMaker
{
    ...
    public static final int TRANSPARENCY = 0; // Transparency ranged from 0 to 255. 0 = full transparency. 255 = no transparency.
    ...
    public static void main(String[] args) {
        ...
        flag = SimpleImageProcessor.resizeAndSetAlpha(flag, BOUNDARY_FLAG_WIDTH, BOUNDARY_FLAG_HEIGHT, 255);
