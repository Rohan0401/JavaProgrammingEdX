...
public class Choice
{
    ...
    public int compareWith(Choice anotherChoice)
    {
        ...
        if ((this.type ==0 && anotherChoice.getType() ==1) || (this.type == 1 && anotherChoice.getType() ==2) ||(this.type == 2 && anotherChoice.getType() == 0)){
            return -1;
        }
    ...
    public void draw(Canvas canvas, int x, int y, int rotation)
    {
        // write your code after this line
         if (this.type == 0) {
            ...
            choiceImage.setX(x);choiceImage.setY(y);choiceImage.setRotation(rotation);
